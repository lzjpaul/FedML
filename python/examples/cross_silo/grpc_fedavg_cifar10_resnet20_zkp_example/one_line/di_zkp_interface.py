...
class ServerInterface(CommonInterface):
    ...
    def finish_noisy_attack(self, *args):
        return _di_zkp_interface.ServerInterface_finish_noisy_attack(self, *args)

    def finish_mp_pd_attack(self, *args):
        return _di_zkp_interface.ServerInterface_finish_mp_pd_attack(self, *args)

    def finish_mp_nt_attack(self, *args):
        return _di_zkp_interface.ServerInterface_finish_mp_nt_attack(self, *args)
